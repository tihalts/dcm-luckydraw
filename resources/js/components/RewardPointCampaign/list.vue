    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Voucher Campaigns</h2>
                </div>
            </div>
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Voucher Campaigns</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                                        ...
                                        <div class="dropdown table__cell-actions-item">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start">
                                                <router-link class="dropdown-item"
                                                    :to="{ name:'editRewardPointCampaign', params: { 'campaign_id': campaign.id }}"
                                                    tag="a">Edit</router-link>
                                                <router-link class="dropdown-item"
                                                    :to="{ name:'RewardPointTemplates', params: { 'campaign_id': campaign.id }}"
                            ...
                            <tr v-show="!campaigns.length">
                                <td colspan="9" class="no-data-found-info">No Voucher Campaigns found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    export default {
        ...
        methods: {
            getCampaigns: function () {
                axios.get('/reward-point-campaign/list')
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchCampaigns: function (page) {
                axios.post('/reward-point-campaign/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.campaigns = response.data;
                        this.totalItems = response.totalItems;
            ...
            remove: function (id, index) {
                axios.delete('/reward-point-campaign/remove/' + id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            active: function (id, index) {
                axios.get('/reward-point-campaign/activated/' + id)
                    .then(r => r.data)
                    .then((response) => {
                        this.campaigns[index] = response.data;
                        this.campaigns.push();
