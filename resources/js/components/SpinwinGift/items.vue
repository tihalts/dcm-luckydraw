    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Spin & Win Gift Items</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <router-link :to="{ name:'SpinAndWins'}" tag="a">Spin & Wins</router-link>
                        </li>
                        <li class="breadcrumb-item">
                ...
                <div class="page-content__header-meta">
                    <router-link :to="{ name:'editSpinAndWinGiftItems' , params: { 'gift_id': $route.params.gift_id }}" tag="a"
            ...
            <div class="container-fh__content dataset">
                ...
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Spin & Win Gift Items</div>
                                        ...
                                        <div class="dropdown table__cell-actions-item">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start">
                                                <router-link class="dropdown-item"
                                                    :to="{ name:'editSpinAndWinGiftItem', params: { 'item_id': item.id , 'gift_id': $route.params.gift_id }}"
...
<script>
    ...
    export default {
        ...
        methods: {
            reports: function () {
                axios.get('/spinner/gift/item/' + this.$route.params.gift_id + '/report')
                    .then(r => r.data)
                    .then((response) => {
            ...
            getGifts: function () {
                axios.get('/spinner/gift/item/list', {
                        params: {
            ...
            searchGifts: function (page) {
                ...
                axios.post('/spinner/gift/item/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.gifts = response.data;
                        this.totalItems = response.totalItems;
            ...
            remove: function (id, index) {
                 this.$swal({
                    ...
                    if (result.value) { // <-- if confirmed                        
                        axios.delete('/spinner/gift/item/remove/' + id)
                            .then(r => r.data)
                            .then((response) => {
            ...
            createGift: function () {
                this.$router.push({
                    path: '/spin-and-wins/gifts/' + this.$route.params.gift_id + '/items/create'
                });
            }
        }
    }
