        ...
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                             <router-link :to="{ name:'SpinAndWins'}"
                                         tag="a">Spin & Wins</router-link>
                        </li>
                ...
                <div class="page-content__header-meta">
                    ...
                    <router-link :to="{ name:'SpinAndWinGiftReport' }" tag="a"
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                                        ...
                                        <div class="dropdown table__cell-actions-item">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start">
                                                <router-link class="dropdown-item"
                                                    :to="{ name:'editSpinAndWinGift', params: { 'gift_id': gift.id , 'spinner_id': $route.params.spinner_id }}"
                                                    tag="a">Edit</router-link>
                                                <router-link class="dropdown-item"
                                                    :to="{ name:'SpinAndWinGiftItems', params: { 'gift_id': gift.id }}" tag="a">
                            ...
                            <tr v-show="!gifts.length">
                                <td colspan="11" class="no-data-found-info">No Spinner gifts found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            reports: function () {
                axios.get('/spinner/gift/'+ this.$route.params.spinner_id +'/report')
                    .then(r => r.data)
                    .then((response) => {
            ...
            getGifts: function () {
                axios.get('/spinner/gift/list', {
                        params: {
                            'spinner_id': this.$route.params.spinner_id
                        }
                    })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchGifts: function (page) {
                this.filter.spinner_id = this.$route.params.spinner_id;
                axios.post('/spinner/gift/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.gifts = response.data;
                        this.totalItems = response.totalItems;
            ...
            remove: function (id, index) {
                this.$swal({
                    ...
                    if (result.value) { // <-- if confirmed
                        axios.delete('/spinner/gift/remove/' + id)
                            .then(r => r.data)
                            .then((response) => {
            ...
            giftWinners: function (id) {
                this.$router.push({
                    path: '/spinner/gifts/' + id + '/winners'
                });
            },
            moveGiftsNextDay: function(){
                axios.get('/spinner/'+ this.$route.params.spinner_id +'/move/unused/gifts')
                    .then(r => r.data)
                    .then((response) => {
            ...
            importGifts: function () {
                this.$router.push({
                    path: '/spin-and-wins/' + this.$route.params.spinner_id + '/gifts/imports'
                });
            },
            createGift: function () {
                this.$router.push({
                    path: '/spin-and-wins/' + this.$route.params.spinner_id + '/gifts/create'
                });
            }
        }
    }
