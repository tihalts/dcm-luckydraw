...
<script>
    ...
    export default {
        ...
        methods: {
            getGift: function () {
                axios.get('/gift/fetch/' + this.$route.params.gift_id , {params: {'campaign_id' : this.$route.params.campaign_id}})
                    .then(r => r.data)
                    .then((response) => {
            ...
            editGift: function () {
                ...
                axios.post('/gift/edit/' + this.$route.params.gift_id, formData, config)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listGift();
