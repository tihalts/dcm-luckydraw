    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Spin & Win Customer Report</h2>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-amaranth">
                            ...
                            </div> <span class="widget-alpha__icon icon-fa fa fa-dollar"></span>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-amaranth widget-alpha--donut">
                            <div>
                                <div class="widget-alpha__amount">{{ data.totalNewCustomers }}</div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-green-jungle">
                            <div>
                                <div class="widget-alpha__amount">{{ data.totalNewCustomerSales }}</div>
                                <div class="widget-alpha__description">New Customer Sales</div>
                            </div> <span class="widget-alpha__icon icon-fa fa fa-dollar"></span>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-orange widget-alpha--donut">
                            <div>
                                <div class="widget-alpha__amount">{{ data.totalExistingCustomers }}</div>
                                <div class="widget-alpha__description">Existing Customers</div>
                            </div> <span class="widget-alpha__icon icon-fa fa fa-gift"></span>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-amaranth widget-alpha--donut">
                            <div>
                                <div class="widget-alpha__amount">{{ data.totalExistingCustomerSales }}</div>
                                <div class="widget-alpha__description">Existing Customer Sales</div>
                            </div> <span class="widget-alpha__icon icon-fa fa fa-dollar"></span>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="widget widget-alpha widget-alpha--color-green-jungle">
                            <div>
                                <div class="widget-alpha__amount">{{ data.totalCustomers }}</div>
                                <div class="widget-alpha__description">Total Customers</div>
                            </div> <span class="widget-alpha__icon icon-fa fa fa-users"></span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getReports: function () {
                axios.post('/spinandwin/total-customer-report' , this.filter)
                    .then(r => r.data)
                    .then((response) => {
            ...
            getReportLists: function (page = 1) {
                axios.post('/spinandwin/customer-report/list/' + page,  this.filter)
                    .then(r => r.data)
                    .then((response) => {
            ...
            exportdata: function () {
                ...
                let routeData = this.$router.resolve({
                    path: '/spinandwin/customer/report/exports',
                    query: this.filter
                });
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/spinandwin/customer/' + type + '/report',
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
