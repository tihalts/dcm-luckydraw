                            ...
                            <div class="from-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" v-model="form.name"
                                        placeholder="Campaign Group Name" required>
                                </div>
                                <div class="form-group">
    ...
    export default {
        ...
        methods: {
            getCampaign: function () {
                axios.get('/campaign-group/fetch/' + this.$route.params.campaign_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editCampaign: function () {
                axios.post('/campaign-group/edit/' + this.$route.params.campaign_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listCampaign();
