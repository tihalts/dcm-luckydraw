                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            ...
                            <tr v-show="!scratchcards.length">
                                <td v-if="$can('admin')" colspan="7" class="no-data-found-info">No Scratch Cards found</td>
                                <td v-if="!$can('admin')" colspan="6" class="no-data-found-info">No Scratch Cards found</td>
                            </tr>
