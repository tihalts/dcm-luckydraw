                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group p-1 pull-right">                            
                            <select name="customer_type" class="form-control" style="min-width:80px;max-width:80px;background: white;" v-model="currentPage" @change="searchVouchers(currentPage)">
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            <tr v-for="( rewardpoint , index ) in rewardpoints" :key="rewardpoint.id">
                                ...
                                <td>
                                    <div class="table__cell-widget" v-if="rewardpoint.customer">
                                        <router-link href="javascript:void(0)" :to="{ name:'CustomerReportPurchases', params: { 'customer_id': rewardpoint.customer.id }}" tag="a" class="table__cell-widget-name">{{ rewardpoint.customer.fullname }}</router-link>
                                        <span class="table__cell-widget-description"><b>Email :</b>
                                            {{ rewardpoint.customer.email }}</span>
                                        <span class="table__cell-widget-description"><b>CPR :</b>
                                            {{ rewardpoint.customer.cpr }}</span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="table__cell-widget" v-if="rewardpoint.provider">
                                        <router-link href="javascript:void(0)" :to="{ name:'PromoterReportPurchases', params: { 'promoter_id': rewardpoint.provider.id }}" tag="a" class="table__cell-widget-name">{{ rewardpoint.provider.fullname }}</router-link>
                                        <span class="table__cell-widget-description"><b>Email :</b>
                            ...
                            <tr v-show="!rewardpoints.length">
                                <td v-if="user.role == 'admin'" colspan="8" class="no-data-found-info">No Vouchers
                                    found</td>
                                <td v-if="user.role != 'admin'" colspan="7" class="no-data-found-info">No Vouchers
                                    found</td>
                            </tr>
                        </tbody>
                    </table>
