    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Create Gift Item</h2>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {  
            createGift: function () {
                ...
                axios.post('/gift/item/create', this.form)
                    .then(r => r.data)
                    .then((response) => {
                        notification('Create Gift Item', "Create Gift Item successfully!", 'success');
                        this.listGift();
                    }).catch((error) => {
                        console.log(error);
                        ...
                        this.errors = typeof error.response.data.errors !== 'undefined' ? error.response.data
                            .errors : null;
                        notification('Create Gift Item', "Create Gift Item Faild!", 'danger');
                    });
            },
            listGift: function () {
                this.$router.push({
                    name: 'GiftItems' , params:{ gift_id : this.$route.params.gift_id }
                });
            }
        }
    }
