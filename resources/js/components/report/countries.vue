    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Purchase Country Wise Report</h2>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getReports: function () {
                axios.get('/purchase-country-report')
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchReports: function (page) {
                ...
                axios.get('/purchase-country-report', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.reports = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportData: function(type){
                let routeData = this.$router.resolve({
                    path: '/purchase-country-report/' + type,
                    query: this.filter
                });
