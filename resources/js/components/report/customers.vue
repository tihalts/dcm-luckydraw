    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Purchase Customer Wise Report</h2>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getReports: function () {
                axios.get('/purchase-customer-report')
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchReports: function (page) {
                ...
                axios.get('/purchase-customer-report', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.reports = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportData: function(type){
                let routeData = this.$router.resolve({
                    path: '/purchase-customer-report/' + type,
                    query: this.filter
                });
