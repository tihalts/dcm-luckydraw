    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Campaign Wise Vouchers</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Campaign Wise Vouchers</div>
    ...
    export default {
        ...
        methods: {
            getCampaigns: function () {
                axios.get('/reports/voucher/by-campaign/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchCampaigns: function (page) {
                ...
                axios.get('/reports/voucher/by-campaign/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.campaigns = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/voucher/by-campaign/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
