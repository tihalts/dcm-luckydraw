    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Day Wise Gifts</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Day Wise Gifts</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            <tr v-for="( gift , index ) in gifts" :key="gift.id">
                                ...
                                <td>{{ gift.date }} </td>
                                <td>{{ gift.total_cards }} </td>
                                <td>{{ gift.total_winners }} </td>
                            </tr>
                            <tr v-show="!gifts.length">
                                <td colspan="4" class="no-data-found-info">No Gifts found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getGifts: function () {
                axios.get('/reports/gift/by-day/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchGifts: function (page) {
                ...
                axios.get('/reports/gift/by-day/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.gifts = response.data;
                        this.totalItems = response.totalItems;
