    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Voucher Wise Customers</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Voucher Wise Customers</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            ...
                            <tr v-show="!vouchers.length">
                                <td colspan="6" class="no-data-found-info">No Vouchers found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    export default {
        ...
        methods: {
            getVouchers: function () {
                axios.get('/reports/customer/by-voucher/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchVouchers: function (page) {
                ...
                axios.get('/reports/customer/by-voucher/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.vouchers = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/customer/by-voucher/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
