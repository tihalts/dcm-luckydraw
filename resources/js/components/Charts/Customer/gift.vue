    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Gift Wise Customers</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Gift Wise Customers</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getGifts: function () {
                axios.get('/reports/customer/by-gift/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchGifts: function (page) {
                ...
                axios.get('/reports/customer/by-gift/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.gifts = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportdata: function () {
             ...
             exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/customer/by-gift/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
