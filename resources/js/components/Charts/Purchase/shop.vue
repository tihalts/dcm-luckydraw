    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Shop Wise Sales</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Shop Wise Sales</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            <tr v-for="( shop , index ) in shops" :key="shop.id">
                                ...
                                <td>{{ shop.name}} </td>
                                <td>{{ shop.total_amount }} </td>
                            </tr>
                            <tr v-show="!shops.length">
                                <td colspan="5" class="no-data-found-info">No Shops found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getShops: function () {
                axios.get('/reports/purchase/by-shop/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchShops: function (page) {
                ...
                axios.get('/reports/purchase/by-shop/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.shops = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/purchase/by-shop/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
