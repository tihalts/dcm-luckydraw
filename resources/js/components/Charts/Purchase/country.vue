    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Country Wise Sales</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Country Wise Sales</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            ...
                            <tr v-show="!countries.length">
                                <td colspan="5" class="no-data-found-info">No Countries found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    export default {
        ...
        methods: {
            getCountries: function () {
                axios.get('/reports/purchase/by-country/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchCountries: function (page) {
                ...
                axios.get('/reports/purchase/by-country/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.countries = response.data;
                        this.totalItems = response.totalItems;
