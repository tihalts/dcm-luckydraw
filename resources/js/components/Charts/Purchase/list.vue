    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Day Wise Sales</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Day Wise Sales</div>
                    ...
                    <div class="dataset__header-controls">
                        <div class="input-group input-group-icon icon-right dataset__header-search">
                            <input class="form-control dataset__header-search-input" v-model="filter.searchText"
                                v-on:keyup="searchSales(1)" type="text" placeholder="Search">
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            ...
                            <tr v-show="!sales.length">
                                <td colspan="3" class="no-data-found-info">No Sales found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col">
                    <paginate v-if="totalPages > 1" :page-count="totalPages" :page-range="3" :margin-pages="2"
                        :click-handler="searchSales" :container-class="'pagination float-right'"
...
<script>
    ...
    export default {
        ...
        methods: {
            getSales: function () {
                axios.get('/reports/purchase/by-day/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchSales: function (page) {
                this.filter.page = page;
                var config = {
                    'params': this.filter
                };

                axios.get('/reports/purchase/by-day/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.sales = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/purchase/by-day/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
