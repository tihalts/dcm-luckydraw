    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Category Wise Sales</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Category Wise Sales</div>
                    ...
                    <div class="dataset__header-controls">
                        <div class="input-group input-group-icon icon-right dataset__header-search">
                            <input class="form-control dataset__header-search-input" v-model="filter.searchText"
                                v-on:keyup="searchCategories(1)" type="text" placeholder="Search">
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                            ...
                            <tr v-show="!categories.length">
                                <td colspan="5" class="no-data-found-info">No Categories found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col">
                    <paginate v-if="totalPages > 1" :page-count="totalPages" :page-range="3" :margin-pages="2"
                        :click-handler="searchCategories" :container-class="'pagination float-right'"
    ...
    export default {
        ...
        methods: {
            getCategories: function () {
                axios.get('/reports/purchase/by-category/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchCategories: function (page) {
                ...
                axios.get('/reports/purchase/by-category/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.categories = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/purchase/by-category/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
