    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Promoter Wise Sales</h2>
                </div>
            ...
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side">
                        <div class="dataset__header-heading">Promoter Wise Sales</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getGifts: function () {
                axios.get('/reports/purchase/by-promoter/list' , { params:  this.filter })
                    .then(r => r.data)
                    .then((response) => {
            ...
            searchGifts: function (page) {
                ...
                axios.get('/reports/purchase/by-promoter/list', config)
                    .then(r => r.data)
                    .then((response) => {
                        this.promoters = response.data;
                        this.totalItems = response.totalItems;
            ...
            exportPdf: function(type){
                ...
                let routeData = this.$router.resolve({
                    path: '/reports/purchase/by-promoter/' + type,
                    query: this.filter
                });
                window.open(routeData.href, '_blank');
            },
