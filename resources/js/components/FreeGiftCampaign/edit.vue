            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="form-group text-right m-b-0">
                        ...
                        <button type="button" @click="editCampaign" class="btn btn-success mb-2 mr-3">Update</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getCampaign: function () {
                axios.get('/free-gift-campaign/fetch/' + this.$route.params.campaign_id)
                    .then(r => r.data)
                    .then((response) => {
                        this.form = response.data;
                        if(this.form.group)
            ...
            editCampaign: function () {
                ...
                axios.post('/free-gift-campaign/edit/' + this.$route.params.campaign_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listCampaign();
