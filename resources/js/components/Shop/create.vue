    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Create Shop</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="main-container">
                        <h3>Shop Create Form</h3>
                        <form role="form" ref="addShopFrom" name="addShopFrom" v-on:submit.prevent="createShop">
