    ...
    <div class="page-content">
        <div class="container-fluid container-fh">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Promoters</h2>                   
                </div>
            </div>
            <div class="container-fh__content dataset">
                <div class="dataset__header">
                    <div class="dataset__header-side"> 
                        <div class="dataset__header-heading">Promoters</div>
                    ...
                    <table id="demo-foo-addrow"
                        ...
                        <tbody>
                                    ...
                                    <div class="table__cell-actions-wrap">
                                        <div class="dropdown table__cell-actions-item">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start"
                                                ...
                                                <router-link  class="dropdown-item" :to="{ name:'editPromoter', params: { 'promoter_id': user.id }}" tag="a">Edit</router-link>
                            ...
                            <tr v-show="!users.length">
                                    <td colspan="7" class="no-data-found-info">No Promoters found</td>
                                </tr>
                        </tbody>
                    </table>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            searchUsers: function (page) {
                axios.post('/promoter/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.users = response.data;
                        this.totalItems = response.totalItems;
            ...
            removeUser: function (id , index) {
                axios.delete('/promoter/remove/' + id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            activeUser: function (id , index) {
                axios.get('/promoter/activated/' + id)
                    .then(r => r.data)
                    .then((response) => {
                        this.users[index] = response.data;
                        this.users.push();
