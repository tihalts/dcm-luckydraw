    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Edit Promoter</h2>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getUser: function () {
                axios.get('/promoter/fetch/' + this.$route.params.promoter_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editUser: function () {
                ...
                axios.post('/promoter/edit/' + this.$route.params.promoter_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listUser();
            ...
            changeUserPassword: function () {
                axios.post('/promoter/change-password/' + this.$route.params.promoter_id, this.change_password)
                    .then(r => r.data)
                    .then((response) => {
