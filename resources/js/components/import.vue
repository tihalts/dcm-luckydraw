    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Import loss data</h2>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            createGifts: function () {
                ...
                //formData.append('campaign_id', this.$route.params.campaign_id );
                var v = this;
                const config = {
                ...
                axios.post('/campaign-loss/imports' , formData, config)
                    .then(r => r.data)
                    .then((response) => {
                        notification('Import loss data', "Import loss data successfully!", 'success');
                        //this.listGift();
                    }).catch((error) => {
                        notification('Import loss data', "Import loss data Faild!", 'danger');
                    });
            },
            ...
            listGift: function () {
                this.$router.push({
                    name: 'Gifts' , params:{ campaign_id : this.$route.params.campaign_id }
                });
            }
        }
    }
