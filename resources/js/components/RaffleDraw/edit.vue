    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Edit Raffle Draw</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="main-container">
                        <h3>Raffle Draw Edit Form</h3>
                        <hr />
                        <form role="form" ref="editRaffleDrawFrom" name="editRaffleDrawFrom" v-on:submit.prevent="editRaffleDraw">
...
<script>
    ...
    export default {
        ...
        methods: {
            getRaffleDraw: function () {
                axios.get('/lucky-draw/fetch/' + this.$route.params.lucky_draw_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editRaffleDraw: function () {
                axios.post('/lucky-draw/edit/' + this.$route.params.lucky_draw_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listRaffleDraw();
