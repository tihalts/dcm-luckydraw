                                ...
                                <div class="form-group">
                                    ...
                                    <div class="file-upload" v-bind:class="{ active: background_img }">
                                        <div class="file-select">
                                            ...
                                            <input type="file" ref="background_img" @change="onBgImgFileChange"
    ...
    export default {
        ...
        methods: {
            createCampaigns: function () {
                axios.post('/scratch-card-campaign/create', this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listCampaign();
            ...
            createCampaign: function () {
                ...
                axios.post('/scratch-card-campaign/create', formData, config)
                    .then(r => r.data)
                    .then((response) => {
