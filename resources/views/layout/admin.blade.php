        ...
        <div class="sidebar-section">
            <div class="sidebar-section__scroll">
                <div>
                    ...
                    <div class="sidebar-section__separator">Campaign Gifts</div>
                    <ul class="sidebar-section-nav">
                        <li class="sidebar-section-nav__item">
                    ...
                    <div class="sidebar-section__separator">Mirrors</div>
                    <ul class="sidebar-section-nav">
                        <li class="sidebar-section-nav__item">
                    ...
                    <ul class="sidebar-section-nav">
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'PurchaseIndexReports' }" tag="a" class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-history"></span>
                                <span class="sidebar-section-nav__item-text">Reports</span>
                            </router-link>
                        </li>
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'chartReports' }" tag="a" class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-bar-chart"></span>
                                <span class="sidebar-section-nav__item-text">Chart Report</span>
                            </router-link>
                        </li>
                        <!-- <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'PurchaseIndexReports' }" tag="a" class="sidebar-section-nav__link">
                        ...
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'ReportPurchaseByCustomers' }" tag="a"
                                class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-history"></span>
                        ...
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'ReportPurchaseByAmounts' }" tag="a"
                                class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-history"></span>
                        ...
                        <!-- <div class="sidebar-section__separator">Spinner Reports</div>
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'SpinnerSaleReports' }" tag="a" class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-history"></span>
                                <span class="sidebar-section-nav__item-text">Sales</span>
                            </router-link>
                        </li>
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'SpinnerCustomerRegisterReports' }" tag="a"
                                class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-history"></span>
                                <span class="sidebar-section-nav__item-text">Register Customer</span>
                            </router-link>
                        </li> -->
                    </ul>
                    ...
                    <ul class="sidebar-section-nav">
                        ...
                        <li class="sidebar-section-nav__item">
                            <router-link :to="{ name:'CampaignGroups' }" tag="a" class="sidebar-section-nav__link">
                                <span class="sidebar-section-nav__item-icon fa fa-shopping-bag"></span>
                                <span class="sidebar-section-nav__item-text">Free Gift Groups</span>
                            </router-link>
                        </li>
                        <li class="sidebar-section-nav__item">
                            ...
                            <ul class="sidebar-section-subnav" style="display: none;">
                                ...
                                <li class="sidebar-section-subnav__item">
                                    <router-link :to="{ name:'SpinAndWins' }" tag="a" class="sidebar-section-nav__link">
                                        Spin & Wins
                                    </router-link>
                                </li>
                            </ul>
...
<script>
    ...
    function printChart(id){
        ...
        var reportPageHeight = $('#' + id).innerHeight();
        var reportPageWidth = $('#' + id).innerWidth();
        ...
        var pdf = new jsPDF('p', 'pt', [400,400]);
        const pdfWidth = pdf.internal.pageSize.width;
        const pdfHeight = pdf.internal.pageSize.height;
        console.log("pdfWidth == " + reportPageHeight);
        pdf.addImage($(pdfCanvas)[0], 'PNG', 20, 20 , 360, 340);
