  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    drawSegments = function() {
      ...
      for (var i = 0; i < numSegments; i++) {
        ...
        destFill = segmentValuesArray[i].fillStyle;
...
window.onresize = function(){
    ...
    var toastWidth = 0;//parseFloat(getComputedStyle(toast).width);
    var toastHeight = 0;//parseFloat(getComputedStyle(toast).height);
    TweenMax.set('.toast', {
      //x:(w/2) - (toastWidth/2),
