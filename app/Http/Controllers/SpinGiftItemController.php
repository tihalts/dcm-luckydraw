...
class SpinGiftItemController extends Controller 
{
    ...
    {     
        try {        
            $giftitems = App\SpinGiftItem::where('status' , true)->where('gift_id' , $request->gift_id);
    ...
    public function updateItems(Request $request)
    {
        ...
        try{
            ...
            foreach ($giftitems as $item) {
                $giftitem = App\SpinGiftItem::find($item['id']);
    ...
    public function deleteItems(Request $request)
    {
        ...
        try{
            $giftitems = App\SpinGiftItem::whereIn('id' , $ids)->get();
            if(!isset($giftitems)){
                $this->response['message'] = "Gift Item(s) not found.!.";
            }
            App\SpinGiftItem::whereIn('id' , $ids)->update(['status' => false]);
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'gift_at' => 'required',
            'gift_id' => 'required|exists:spin_gifts,id',
        ]);
    ...
    {
        try{
            $giftitem = App\SpinGiftItem::find($id);
            $toArray = [
              'id' => $giftitem->id,
              'code' => $giftitem->code ,
    ...
    public function fetchCampaigns(Request $request)
    {
        try {      
            $filter = $request->all(); 
            $giftitems = App\SpinGiftItem::where('status' , true)
